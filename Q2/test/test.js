...
describe("Multiplier3_Groth16", function () {
  let Verifier;
  let verifier;

  beforeEach(async function () {
      Verifier = await ethers.getContractFactory("Multiplier3_groth163Verifier");
      verifier = await Verifier.deploy();
      await verifier.deployed();
  });
  ...
  it("Should return true for correct proof", async function () {
      ...
      console.log('1x2*3 =',publicSignals[0]);
...
describe("Multiplier3_plonkverifier", function () {
  let Verifier;
  let verifier;
  ...
  it("Should return true for correct proof", async function () {
      ...
      var text = fs.readFileSync("/home/parallels/Desktop/Week1/week1/Q2/contracts/circuits/Multiplier3-plonk/call.txt", 'utf-8');
